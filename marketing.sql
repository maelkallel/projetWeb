...
--
-- Client :  127.0.0.1
-- Généré le :  Lun 22 Avril 2019 à 17:35
...
--
-- Structure de la table `eveent`
--

CREATE TABLE IF NOT EXISTS `eveent` (
...
--
-- Contenu de la table `eveent`
--

INSERT INTO `eveent` (`title`, `dd`, `df`, `max`, `des`) VALUES
('redg', '2020-12-12', '2021-12-12', 12, 'sqc');
...
INSERT INTO `membres` (`id_membre`, `pseudo`, `mail`, `motdepasse`) VALUES
(1, 'maoula', 'mael.kallel@esprit.tn', '2345fb39563f88e7b2ea120b8b463a5f89ee6a67');
...
INSERT INTO `promo` (`idP`, `dd`, `df`, `prom`) VALUES
(0, '2019-04-27', '2019-04-30', 30),
(1, '2019-04-27', '2019-04-30', 20);
