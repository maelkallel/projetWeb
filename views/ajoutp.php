...
if ( isset($_POST['dd']) and isset($_POST['df']) and isset($_POST['idP']) and isset($_POST['prom']) and isset($_POST['id'])


and  $_POST['idP']!=null   and  $_POST['prom']!=null  and  $_POST['dd']!=null and  $_POST['df']!=null and $_POST['id'] )
		 {
				...
				$today=date("Y-m-d");
					...
					{  
									...
									$promo1=new promo($idP,$dd,$df,$prom,$id);
