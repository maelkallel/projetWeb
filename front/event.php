                    ...
                    <div class="col-xl-4 col-lg-5">
                        <div class="user-panel">
                            <div class="up-item">
                                ...
                                <a href="connexion.php">Sign</a> In or <a href="inscription.php">Create Account</a>
                            </div>
                            <div class="up-item">
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="cart-table">
                            <h3>EVENEMENTS</h3>
                            <form action="verifform.php" method="get" class="promo-code-form" > 
...
$listeevent=$event1C->afficherEvents();
                            if(isset($_POST['tri']))
{
    $listeevent=$db->query("SELECT * FROM `eveent` ORDER BY `eveent`.`df` ASC");
}
else if(isset($_POST['tria']))
{
    $listeevent=$db->query("SELECT * FROM `eveent` ORDER BY `eveent`.`df` DESC");
                        ...
                        <button type="submit" name="tria" class="fa fa-arrow-circle-o-up"></button>
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="total-th">Maximum de participant</th>
                                </tr>
                            </thead>
                             <?PHP
                            ...
                            <tbody>
                                <tr>
                                 ...
                                 <td class="size-col"><h4> <?PHP echo $row['dd']; ?></h4></td>
                                    ...
                                    <td class="total-col"><h4><?PHP echo $row['max']; ?></h4></td>
                                    <td><form method="POST" action="participation.php">
            <input type="submit" name="participer" value="participer"  class="site-btn sb-line sb-dark" onclick="disableButton(this)" <?php if ($row['max']==0  ) { ?> disabled  <?php  } ?> >
